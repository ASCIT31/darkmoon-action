...
> **📦 Marketplace status:** Live on the [GitHub Marketplace](https://github.com/marketplace/actions/darkmoon-pentest). Use it via `uses: ASCIT31/darkmoon-action@v0.1.0`.
